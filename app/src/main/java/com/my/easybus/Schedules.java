...
public class Schedules extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        prgDialog=new ProgressDialog(Schedules.this);
        ...
        llm = new LinearLayoutManager(Schedules.this);
        mLayoutManager = new GridLayoutManager(Schedules.this, 1);
    ...
    public class RequestTast extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... arg0) {
            return  LogicClass.getSchedule(Schedules.this,source,destination,time,"1");
        }
        @Override
        protected void onPostExecute(String result) {
          ...
          //  Utility.shoAlert(result,Schedules.this);
            ...
            if(result.startsWith("[{")) {
                ArrayList<Schedule> list = LogicClass.getScheduleList(Schedules.this, result);
                Data.SaveSchedules(Schedules.this,result,source,destination);
                adapter = new ScheduleAdapter(Schedules.this, list);
    ...
    private void local()
    {
        String result=Data.getSchedules(Schedules.this,source,destination);
        if(result.startsWith("[{")) {
            ArrayList<Schedule> list = LogicClass.getScheduleList(Schedules.this,result);
            adapter = new ScheduleAdapter(Schedules.this, list);
            rv.setAdapter(adapter);
