...
public class getSchedulesDriversMine extends Fragment {
    ...
    public getSchedulesDriversMine() {
    }
    @Override
    ...
    public class RequestTast extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... arg0) {
            return  LogicClass.getSchedule(getActivity(),source,destination,time,"2");
        }
        @Override
