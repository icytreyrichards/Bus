    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String search) {
                //Do some magic
                Intent s=new Intent(MainActivity.this,SearchRoutes.class);
...
//////************//////////
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            acc.setArguments(b);
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.content_frame, acc, "").commit();
        }
...
//get my recent schedules
    ...
    public class GCMTast extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            return LogicClass.FCM(MainActivity.this,refreshedToken);
        }
        @Override
        protected void onPostExecute(String result) {
           ...
           //Utility.showAlert(result,MainActivity.this);
        }
    }
    void requestCamera() {
