...
public class DriversActivity extends AppCompatActivity
    ...
    private  Intent s=new Intent(DriversActivity.this,SearchTickets.class);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(final String search) {
                ...
                AlertDialog.Builder alert=new AlertDialog.Builder(DriversActivity.this);
                alert.setPositiveButton("Search Routes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        s=new Intent(DriversActivity.this,SearchRoutes.class);
                ...
                alert.setNeutralButton("Search Tickets", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        s=new Intent(DriversActivity.this,SearchTickets.class);
                        s.putExtra("search",search);
                        startActivity(s);
                    }
                });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getSchedulesDrivers fra=new getSchedulesDrivers();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            //live Map
            Intent i=new Intent(DriversActivity.this, TrackNow.class);
            startActivity(i);
            return true;
        }
            ...
            bundle.putString("destination","");
            bundle.putString("time","All");
            getSchedulesDriversMine fra=new getSchedulesDriversMine();
            fra.setArguments(bundle);
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.content_frame,  fra, "").commit();
            getSupportFragmentManager().beginTransaction()
            ...
            Intent i=new Intent(DriversActivity.this,UpdateProfile.class);
            startActivity(i);
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent i=new Intent(DriversActivity.this,AddPickups.class);
            startActivity(i);
            return true;
        }
...
//get my recent schedules
    ...
    public class GCMTast extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... arg0) {
            ...
            return LogicClass.FCM(DriversActivity.this,refreshedToken);
        }
        @Override
    ...
    public class RequestTastPost extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... arg0) {
            return  LogicClass.getTicketDetails(DriversActivity.this,arg0[0]);
        }
        @Override
        protected void onPostExecute(String result) {
            // TODO Auto-generated method stub
            super.onPostExecute(result);
            Utility.showAlert(result,DriversActivity.this);
        }
    }
    void requestCamera() {
